...
# source: graphviewer/proto/tensor.proto
...
from graphviewer.proto import resource_handle_pb2 as graphviewer_dot_proto_dot_resource__handle__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='graphviewer/proto/tensor.proto',
  package='tensorflow',
  syntax='proto3',
...
_TENSORPROTO.fields_by_name['dtype'].enum_type = graphviewer_dot_proto_dot_types__pb2._DATATYPE
_TENSORPROTO.fields_by_name['tensor_shape'].message_type = graphviewer_dot_proto_dot_tensor__shape__pb2._TENSORSHAPEPROTO
_TENSORPROTO.fields_by_name['resource_handle_val'].message_type = graphviewer_dot_proto_dot_resource__handle__pb2._RESOURCEHANDLEPROTO
...
TensorProto = _reflection.GeneratedProtocolMessageType('TensorProto', (_message.Message,), dict(
  ...
  __module__ = 'graphviewer.proto.tensor_pb2'
