...
# source: graphviewer/proto/graph.proto
...
from graphviewer.proto import function_pb2 as graphviewer_dot_proto_dot_function__pb2
from graphviewer.proto import versions_pb2 as graphviewer_dot_proto_dot_versions__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='graphviewer/proto/graph.proto',
  package='tensorflow',
  syntax='proto3',
...
_GRAPHDEF.fields_by_name['node'].message_type = graphviewer_dot_proto_dot_node__def__pb2._NODEDEF
_GRAPHDEF.fields_by_name['versions'].message_type = graphviewer_dot_proto_dot_versions__pb2._VERSIONDEF
_GRAPHDEF.fields_by_name['library'].message_type = graphviewer_dot_proto_dot_function__pb2._FUNCTIONDEFLIBRARY
...
GraphDef = _reflection.GeneratedProtocolMessageType('GraphDef', (_message.Message,), dict(
  ...
  __module__ = 'graphviewer.proto.graph_pb2'
